...
interface BlogPostDocumentData {
  ...
  /**
   * asd field in *Blog Post*
   *
   * - **Field Type**: Link
   * - **Placeholder**: dsa
   * - **API ID Path**: blog_post.asd
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  asd: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;
...
export interface ContentIndexSliceDefaultPrimary {
  ...
  /**
   * Read More Text field in *ContentIndex → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.default.primary.read_more_text
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  read_more_text: prismic.KeyTextField;

  /**
   * View Project field in *ContentIndex → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.default.primary.view_project
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  view_project: prismic.LinkField<
    string,
